...
- **Bounded provider failover**: An unpinned policy-selected child may retry once after a structured pre-tool 429; explicit pins and post-tool failures never replay (patch #17, ADR-0122)
