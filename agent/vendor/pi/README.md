...
> **Pinned to pi `v0.80.2-psmfd.1`** (source: PSMFD-attested rebuilds on
> [`psmfd/pi`](https://github.com/psmfd/pi/releases), upstream base `0.80.2`).
>
